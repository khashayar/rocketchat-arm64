...
ARG ARCH=aarch64
ARG DENO_SHA=3335cd10a3c17afa5a44fc79484cd3471ca151afa5d9ba6080e55a7faa7dafb5
...
RUN set -ex \
  ...
  && echo "${DENO_SHA} /tmp/deno-${ARCH}-unknown-linux-gnu.zip" | sha256sum -c - \
